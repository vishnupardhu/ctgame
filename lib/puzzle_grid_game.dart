...
class PuzzleGridFourGame extends StatefulWidget {
  const PuzzleGridFourGame({super.key});

  @override
  State<PuzzleGridFourGame> createState() => _PuzzleGridFourGameState();
}

class _PuzzleGridFourGameState extends State<PuzzleGridFourGame> {
   File? _imageFile;
  img.Image? _image;
