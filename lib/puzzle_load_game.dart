...
class PuzzleCtGAmethree extends StatefulWidget {
  const PuzzleCtGAmethree({super.key});

  @override
  State<PuzzleCtGAmethree> createState() => _PuzzleCtGAmethreeState();
}

class _PuzzleCtGAmethreeState extends State<PuzzleCtGAmethree> {
   File? _imageFile;
  img.Image? _image;
